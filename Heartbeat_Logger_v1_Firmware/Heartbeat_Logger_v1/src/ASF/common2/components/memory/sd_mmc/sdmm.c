...
#include <asf.h>			/* Include device specific declareation file here */
#include "conf_board.h"


#define DO			ioport_get_pin_level(SD_MISO_PIN)		/* Test for MMC DO ('H':true, 'L':false) */

#define DI_H()		ioport_set_pin_level(SD_MOSI_PIN, HIGH)				/* Set MMC DI "high" */
#define DI_L()		ioport_set_pin_level(SD_MOSI_PIN, LOW)				/* Set MMC DI "low" */
	
#define CK_H()		ioport_set_pin_level(SD_CLK_PIN, HIGH)				/* Set MMC SCLK "high" */
#define	CK_L()		ioport_set_pin_level(SD_CLK_PIN, LOW)				/* Set MMC SCLK "low" */
